...
- `components/{feature}/modals/` → Feature modals grouped
...
- `<style scoped>` for app components, unscoped for ui-vue atoms
...
- Strict mode
- `interface` for object shapes (props, state)
- `type` for unions and aliases
- Zod for runtime validation
- Types co-located in ui-vue, separate `/types/` in apps
